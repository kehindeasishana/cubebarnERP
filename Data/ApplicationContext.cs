...
namespace Data
{
    public class ApplicationContext : DbContext, IDbContext
    {
        ...
        public ApplicationContext(string name) 
            : base(name)
        {
            Database.SetInitializer<ApplicationContext>(new DropCreateDatabaseIfModelChanges<ApplicationContext>()); //uncomment this line to disable code first
        }
       ...
       // public DbSet<CompanySetting> CompanySettings { get; set; }
        ...
        //public System.Data.Entity.DbSet<Core.Domain.Administration.Tax> Taxes { get; set; }
